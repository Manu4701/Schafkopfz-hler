...
let spieler = [
  ...
  {name: "Maxi", spielstand: null, gamesWon: 0, gamesLost: 0},
  {name: "Jonas", spielstand: null, gamesWon: 0, gamesLost: 0},
...
function wertefestlegen() {
  ...
  spielkosten = (grundkosten + laufendeKosten + schneiderSchwarzKosten) * Math.pow(2,anzahlGelegt) * tarifMultiplikator
}
